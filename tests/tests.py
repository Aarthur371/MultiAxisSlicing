...
from parser.parser6axis import calculDirectionDepl, export_commandes_robot, extraire_gcode, extraire_gcode_Open5x, gcode_s3slicer, export_commandes_robot_split
...
# # Resultat : ok
# inFile = "parser\\input\\calotte_spherique_reversed_Gcode.txt"
# outFile = "parser\\output\\calotte_reversed_cmdsRobot.txt"
# vitLin = 21
# vitAng = 3.14/12
# repere = "/RPlateau"
# donnees = extraire_gcode(inFile)
...
# inFile = "parser\\input\\rhino_Gcode.txt"
# outFile = "parser\\output\\rhinoTest_cmdsRobot.txt"
# vitLin = 21
# vitAng = 3.14/12
# repere = "/RPlateau"
